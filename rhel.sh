...
[base]
name=BASE
baseurl=http://abf-downloads.rosalinux.ru/$PRODUCTNAME/repository/$ARCH/base/release/
gpgcheck=0

[abf-worker-service]
name=abf-worker-service
baseurl=http://abf-downloads.rosalinux.ru/abf_personal/repository/$PRODUCTNAME/$ARCH/base/release/
gpgcheck=0
EOF
...
/usr/sbin/chroot $ch /bin/bash -c "cd $ch/opt/VAGRANT-LXC-BOX-BUILD/boxes; ./build-rels-box.sh $PRODUCTNAME $ARCH" > /home/vagrant/results/build.log 2>&1
